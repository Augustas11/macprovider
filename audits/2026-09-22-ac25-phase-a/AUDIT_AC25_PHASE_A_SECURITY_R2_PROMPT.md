...
## Lane: SECURITY REVIEW — settlement safety, cross-request contamination,
DoS levers, secret disclosure. Can `release(_:)` be abused to force a second
execution of an already-claimed request? Can the Retry-After value leak
provider capacity information useful to an attacker?
