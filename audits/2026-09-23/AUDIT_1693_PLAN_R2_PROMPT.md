...
Round 2: the plan is now v2 (header lists how round-1 findings P01-P09 were addressed). Independently verify each is truly closed AND hunt for new defects introduced by v2 (coordinator C1 publication, journal, writer guard, --expect-base-equivalent). Do not anchor on round 1.
