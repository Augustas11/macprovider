...
| id | status | owner | blocker | summary |
|---|---|---|---|---|
| SPEC-004/Pillar-A | ready | operator | [#170](https://github.com/Augustas11/macprovider/issues/170) | Sticky affinity. **2026-06-26 triage:** Upgraded from `gated` to `ready`. SPEC-006 v0.8 (audited ACCEPT, gate PG-9 in §22 production launch checklist) satisfies the sticky-caching guard; SPEC-004 v0.2 normative routing contract is in place. Remaining work tracked in issue [#170](https://github.com/Augustas11/macprovider/issues/170): draft `BUILD_SPEC_004_PILLARS_BCDA_PROMPT.md`, IMPL behind `routing.sticky_enabled: false` default, then operator green-lights the flip. Estimated 4–6 weeks across 3–4 pillar-sized PRs. No code blocker. |
