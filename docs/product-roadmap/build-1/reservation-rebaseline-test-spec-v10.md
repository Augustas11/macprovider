# Build 1 preparation-reservation rebaseline test specification v10

Status: revised acceptance specification for `reservation-rebaseline-plan-v10.md` after the blocking preparation-authority v5 review. No implementation test may be credited before the corrected, complete operator-owned authority commit in T18 lands. This revision does not claim the adversarial gate passed.

Implementation baseline: `c4401f1791d593d37d68eba91af94219b26d278f`. Planning/review baseline: `f7e584499828b3d16036382848b5caa1a897cdf9`. Authority revision reviewed by v5: `4196d6d9850632386130b6d658325632e4d80b38`; formal v5 review artifact commit: `02faf9a2bc47189e83894826183a12a76719a45d`.

Revision inputs: v9 plan SHA-256 `217db6fbabc76433004ee835cfb8846099d0855132cf141e2c91a3e051d8a90d`; v9 test-spec SHA-256 `245d1fd3652a5e445b525c2567517cc51e80b8e4437a91ce5e375784268d92c2`; blocking review `reviews/preparation-authority-v5-sol.md`, SHA-256 `7566693203c38f8684268c9b3665384cfce5639f90cf6a1ec8582f52e86659dd`. T18 records SHA-256 digests from the committed v10 bytes.
...
6. SHA-256 digests are computed from and archived for the committed v10 plan and test specification; fresh independent review of those exact bytes plus the landed SPEC diff has zero Critical/High/Medium and explicitly dispositions B1-AUTH-V5-H1/M1-M3, B1-AUTH-V4-H1/M1-M4, B1-AUTH-V3-H1-H3/M1-M3, B1-AUTH-H1/H2/M1-M13, and B1-AUTH-V2-H1-H4/M1-M5.
