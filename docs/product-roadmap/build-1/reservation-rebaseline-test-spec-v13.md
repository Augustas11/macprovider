# Build 1 preparation-reservation rebaseline test specification v13

Status: acceptance specification for `reservation-rebaseline-plan-v13.md`, aligned to the concurrent preparation authority v8 correction after the blocking v7 review. No implementation test may be credited before the corrected, complete operator-owned authority commit in T18 lands. This revision does not claim the adversarial gate passed.

Implementation baseline: `c4401f1791d593d37d68eba91af94219b26d278f`. Planning/review baseline: `f7e584499828b3d16036382848b5caa1a897cdf9`. Finalized authority v8 revision: `d4f5eeb0dec4120811ac76afccdfc70a72e3483d`; forward-current authority versions are SPEC-001 v1.9.16 and SPEC-044 v0.2.7. Formal v7 review artifact commit retained as correction input: `767f20b399b41baf658ef043decb785a482684af`.

Revision inputs: v12 plan SHA-256 `6957c36e6104f8d4d04c9d2f429a86207083ca7e4ff53302cb45b717691ed418`; v12 test-spec SHA-256 `68fd90bbbeb1bf21cae866c0155ffa5ffff4a08dcbfd617882abf4df737f23ed`; blocking review `reviews/preparation-authority-v7-sol.md` at commit `767f20b399b41baf658ef043decb785a482684af`, SHA-256 `e1872075dc033046c46f6582c25f070537ba8e2d482a1e6ce1c36bfe7d2db858`. T18 records the exact authority v8 revision/version and SHA-256 digests from the committed v13 bytes.
...
- every forward-current owner reference selects SPEC-044 v0.2.7; v0.2.6 and older versions appear only in explicitly historical records; `SPEC-001-R003`, its pending CONFORMANCE entry, AUTHORITY consumers, SPEC/version indexes and digests, and SPEC-044-R005 evidence/gap mapping agree;
...
4. SPEC-001 §6.14b is `SPEC-001-R003` with a pending CONFORMANCE entry; every forward-current reference to SPEC-044 in SPEC-001, SPEC-044 implementation/evidence text, CONFORMANCE, AUTHORITY, generated indexes, current handoffs, contract locks, and these v13 planning artifacts names v0.2.7, while references to v0.2.6 and earlier are explicitly historical changelog/review context; AUTHORITY registers the applicable SPEC-044 consumer; R005 no longer credits the contradictory hide test and instead records the explicit gap and named future visible-local-preparation proof; versions, generated indexes, CONFORMANCE, #1485 ownership/copy, committed file SHA-256 digests, and authority-review lineage all agree exactly.
5. `git merge-base --is-ancestor <authority-commit> <first-6B-commit>` succeeds and commits differ.
6. SHA-256 digests are computed from and archived for the committed v13 plan and test specification; fresh independent review of those exact bytes plus the landed SPEC diff has zero Critical/High/Medium and explicitly dispositions B1-AUTH-V7-H1/H2/M1, B1-AUTH-V6-H1/H2/M1/M2, B1-AUTH-V5-H1/M1-M3, B1-AUTH-V4-H1/M1-M4, B1-AUTH-V3-H1-H3/M1-M3, B1-AUTH-H1/H2/M1-M13, and B1-AUTH-V2-H1-H4/M1-M5.
...
| B1-AUTH-V6-M1 | T18 | Every forward-current owner, implementation, evidence, index, handoff, contract-lock, and planning reference selects SPEC-044 v0.2.7 with exact committed digests. |
