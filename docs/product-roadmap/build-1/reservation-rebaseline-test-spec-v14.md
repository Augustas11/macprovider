# Build 1 preparation-reservation rebaseline test specification v14

Status: acceptance specification for `reservation-rebaseline-plan-v14.md`, corrected after the blocking formal v8 review and aligned to finalized preparation authority v8. No implementation test may be credited before the corrected, complete operator-owned authority commit in T18 lands. This revision does not claim the adversarial gate passed.
