# Build 1 preparation-reservation rebaseline test specification v16

Status: acceptance specification for `reservation-rebaseline-plan-v16.md`, corrected after the blocking formal v9 review and aligned to the corrected preparation authority candidate. No implementation test may be credited before the corrected, complete operator-owned authority commit in T18 lands. This revision does not claim the adversarial gate passed.
...
Revision inputs: v15 plan SHA-256 computed from `docs/product-roadmap/build-1/reservation-rebaseline-plan-v15.md`; v15 test-spec SHA-256 computed from `docs/product-roadmap/build-1/reservation-rebaseline-test-spec-v15.md`; blocking review `reviews/preparation-authority-v9-sol.md` at commit `fa71b09c6bdcc0478a211435849cccc8c13b4460`, SHA-256 `75cec387364175b67559eb81fb4322f97de423befaa5997d066e741dd002e5b8`; landed authority evidence from `origin/main` commit `c8c97f6625a88fa7c83ae2b5cf4d68078409cc6f`. T18 records the exact corrected authority candidate revision/version and SHA-256 digests from the committed v16 bytes.
