# Build 1 preparation-reservation rebaseline test specification v20

Status: acceptance specification for `reservation-rebaseline-plan-v20.md`, corrected after the independent v19 gate found one remaining stale Slice 6A review target and aligned to landed authority merge `c8c97f6625a88fa7c83ae2b5cf4d68078409cc6f`. No secure-storage implementation test may be credited before T18 proves its implementation descends from that landed merge and the current v20 exact bytes pass independent review. The contract-only candidate in PR #1491 must be amended to the approved v20 representation. This revision does not claim the adversarial gate passed.
...
Revision inputs: v19 plan SHA-256 `ff85789dd13a40b19a7c11f629588b6903c3c2f45f357837ed8b6455daa1a098`; v19 test-spec SHA-256 `4ed1bb95bc2591f59fe48d7e56a8126a4e81fc5b0687327a963ee0c5a699b04d`; independent v19 gate result 0 Critical, 0 High, 1 Medium, requiring the last Slice 6A review target to select v20 rather than v18; landed authority evidence from `origin/main` commit `c8c97f6625a88fa7c83ae2b5cf4d68078409cc6f`. T18 records the landed authority merge and SHA-256 digests from the committed v20 bytes.
