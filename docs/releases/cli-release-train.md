...
| Next candidate | **`v1.8.195` reserved** for the Studio successor to 192: signed from `main` @ `03627cda` (#1742, batched sampling, M4 cached turns, Qwen3.6 throughput, provider LaunchAgent `Standard`), run [36094723519](https://github.com/Augustas11/macprovider/actions/runs/36094723519), `promotion_ready=false`. `v1.8.194` is the Pearl runtime cut for #1744. Studio-only; `binaryVersion` stays 1.8.123; re-declare the accepted tuple from its `runtime-identity` line before the swap. |
