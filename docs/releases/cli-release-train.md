...
| Next candidate | **`v1.8.201` reserved** for the single signed #1757 campaign closeout candidate from `main` @ `0197f379`, branch `release/candidate-1.8.201`, `promotion_ready=false`. Studio-only confirmation candidate; `binaryVersion` stays 1.8.123 and the fleet recommendation does not move. |
