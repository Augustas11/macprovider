...
- `specs/AUTHORITY.json` for shared concept ownership;
...
validates unique SPEC and requirement IDs, unique authority ownership, lifecycle
and conformance states, structured cross-SPEC references, file mappings, journey
references, evidence dates, commit/digest evidence, and exact title/version
alignment with canonical SPEC headers.
