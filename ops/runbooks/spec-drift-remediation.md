...
| 12 | SPEC-001 v1.7 consolidation (spec v1.6 vs binary **1.8.31**; FR-11 semaphore, FR-16 idle-prewarm, mode-based handshake, 17-frame control socket, §6.15 additive wire) — **PR [#572](https://github.com/Augustas11/macprovider/pull/572) open, 10-round audit converged 0 C/H/M** | D | L | spec | `CoordinatorClient.swift` (1.8.31) |
