...
enum AutoUpdateFailureClass: String, CaseIterable, Sendable {
    ...
    case releasePayloadIncomplete = "release_payload_incomplete"
    ...
    case postStartNetworkUnavailable = "post_start_network_unavailable"
    case postStartNetworkNotReady = "post_start_network_not_ready"
    case rollbackTargetDisallowed = "rollback_target_disallowed"
    case discoveryHeadReplay = "discovery_head_replay"
    case discoveryHeadEquivocation = "discovery_head_equivocation"
    case discoveryHeadExpired = "discovery_head_expired"
