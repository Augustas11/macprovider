...
final class RouterHandler: ChannelInboundHandler, @unchecked Sendable {
    ...
    static let localStatusCapabilities = [
        ...
        "model_catalog_transactions_v1",
        "model_catalog_local_activation_v1",
        "model_catalog_read_lifecycle_v1",
        "model_catalog_read_event.v1",
        "model_catalog_transaction_event.v1",
        "model_ready_switch_v1",
        "model_recommendation_check_v1",
        "model_recommendation_apply_switch_v1",
        "models status",
        "models list.v1",
        "models browse.v1",
        "models catalog-economics.v1",
        "model_catalog_error.v1",
        "models switch.v1",
        "autotune recommend installed-only check.v1",
        "autotune_recommend.v1",
        "model_recommendation_check_event.v1",
        "models adopt-recommendation.v1",
        "model_adoption_event.v1",
        "model_recommendation_apply_switch.v1",
        "recommendation_apply_switch_prepare_request",
        "recommendation_apply_switch_prepare_result",
        "recommendation_apply_switch_apply_request",
        "recommendation_apply_switch_cancel_request",
        "recommendation_apply_switch_cancel_result",
        "recommendation_apply_switch_finalize_request",
        "recommendation_apply_switch_finalize_result",
        "recommendation_apply_switch_recovery_claim_request",
        "recommendation_apply_switch_recovery_claim_result",
        "recommendation_apply_switch_progress",
        "status_request",
        "status_response",
        "models_request",
        "models_response",
