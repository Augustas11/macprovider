...
struct ProviderLifecycleStateRecord: Codable, Equatable, Sendable {
    ...
    static let authority = "malibu_cli"
    static let legacyAuthority = "macprovider_cli"

    static func acceptsAuthority(_ candidate: String) -> Bool {
        candidate == authority || candidate == legacyAuthority
    }
    ...
    func validate() throws {
        ...
        guard Self.acceptsAuthority(authority) else {
