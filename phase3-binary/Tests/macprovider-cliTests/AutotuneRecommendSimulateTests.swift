...
final class AutotuneRecommendSimulateTests: XCTestCase {
    func testEnvelopeDecodeRoundTripBuildsEngineRequest() async throws {
        ...
        XCTAssertEqual(request.candidateCatalog.version, "published-2026-09-19-openrouter-listed-v1")
        XCTAssertEqual(request.demandRank.version, "published-2026-09-19-openrouter-listed-v1")
    }
    ...
    func testLiveSentinelFetchesRateCardAndUsesBakedStaticInputs() async throws {
        ...
        XCTAssertEqual(result.candidateCatalogVersion, "published-2026-09-19-openrouter-listed-v1")
        XCTAssertEqual(result.demandRankVersion, "published-2026-09-19-openrouter-listed-v1")
    }
