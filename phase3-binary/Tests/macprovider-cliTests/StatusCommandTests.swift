...
final class StatusCommandTests: XCTestCase {
    ...
    func testRoutineCLIHelpUsesCanonicalPublicLanguage() {
        ...
        let helpMessages = [
            ...
            ProviderContextCommand.helpMessage(),
            ProviderContextExplainCommand.helpMessage(),
            ProviderContextSetCommand.helpMessage(),
            ProviderContextRollbackCommand.helpMessage(),
