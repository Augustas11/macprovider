...
final class AutotuneRecommendTests: XCTestCase {
    ...
    func testHMACSecretStoreDoesNotCallKeychainAPIs() {
        ...
        let url = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/malibu-cli/AutotuneRecommend.swift")
    ...
    func testTranscriptDoesNotOfferUnreadYPrompt() throws {
        ...
        XCTAssertTrue(result.humanTranscript(configurationApplied: true).contains("malibu-cli serve"))
    }
