...
final class ProviderStatusTests: XCTestCase {
    ...
    func testStatusResponsePublishesVersionedLocalCapabilityContract() async throws {
        ...
        XCTAssertEqual(contract["lifecycle_owner"] as? String, "malibu_cli")
