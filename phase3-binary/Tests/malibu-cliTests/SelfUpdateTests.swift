...
final class SelfUpdateTests: XCTestCase {
    ...
    func testDiscoveryHeadBindsSetVersionWhileCLIAndMalibuVersionsCanDiffer() throws {
        ...
        let prepared = PreparedSelfUpdate(
            ...
            newBinary: URL(fileURLWithPath: "/tmp/malibu-cli-test"),
            stagedMalibuApp: nil,
            signedPolicy: nil,
    ...
    func testValidatedUpdateDrainsBeforeReplacingAndRestartingLaunchd() async throws {
        ...
        let binary = URL(fileURLWithPath: "/tmp/malibu-cli-test")
        let update = SelfUpdate(
    ...
    func testReadinessFailureRollsBackReplacement() async throws {
        ...
        do {
            try await update.applyValidatedUpdateForTest(newBinary: URL(fileURLWithPath: "/tmp/malibu-cli-test"))
    ...
    func testPayloadTransactionRestoresBinaryAndAdjacentResources() throws {
        ...
        let currentBinary = current.appendingPathComponent("malibu-cli")
    ...
    func testPayloadValidationRejectsIncompleteReleaseBeforeActivation() throws {
        ...
        let binary = root.appendingPathComponent("malibu-cli")
    ...
    func testStaleLocalStatusOwnerSelectsOnlyOldServeProcessAtExpectedPath() {
        ...
        XCTAssertEqual(
            SelfUpdate.staleLocalStatusOwnerPIDToTerminate(
                ...
                expectedExecutablePath: "/Users/provider/macprovider/malibu-cli",
                currentProcessID: 82367,
                executablePath: { pid in
                    pid == 60750 ? "/Users/provider/macprovider/malibu-cli" : nil
                }
            ),
            60750
        )
    ...
    func testStaleLocalStatusOwnerDoesNotSelectCurrentProcessWrongRoleOrUnknownVersion() {
        ...
        XCTAssertNil(SelfUpdate.staleLocalStatusOwnerPIDToTerminate(
            ...
            executablePath: { _ in "/Users/provider/macprovider/malibu-cli" }
        ))
        ...
        XCTAssertNil(SelfUpdate.staleLocalStatusOwnerPIDToTerminate(
            ...
            expectedExecutablePath: "/Users/provider/macprovider/malibu-cli",
            currentProcessID: 82367,
            executablePath: { _ in "/tmp/malibu-cli" }
        ))
    }
        ...
        MockURLProtocol.responses = [
            tagURL: (
                ...
                """
                {
                  ...
                  "assets": [
                    {
                      "name": "malibu-cli-v1.2.1-darwin-arm64.tar.gz",
                      "browser_download_url": "https://github.com/Augustas11/macprovider/releases/download/v1.2.1/malibu-cli-v1.2.1-darwin-arm64.tar.gz"
                    },
                    {
                      "name": "checksums.txt",
...
private func updateTestManifest(
    ...
    UninstallCommand.InstallManifest(
        ...
        version: "1.8.106",
        binaryPath: "/tmp/macprovider/malibu-cli",
        symlinkPath: "/tmp/bin/malibu-cli",
        launchdPlists: [
