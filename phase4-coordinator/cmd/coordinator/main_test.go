...
func TestRouteSnapshotSQLiteKeepsBoundedDedicatedWriterLane(t *testing.T) {
	...
	if routeSnapshotJournalSQLiteMaxOpenConns != 1 {
		t.Fatalf("route snapshot journal SQLite max open conns=%d, want one serialized writer", routeSnapshotJournalSQLiteMaxOpenConns)
	}
