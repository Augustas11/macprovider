...
ALTER TABLE ledger_request_credits ALTER COLUMN requested_privacy_mode SET DEFAULT 'none';
ALTER TABLE ledger_request_credits ALTER COLUMN requested_privacy_mode SET NOT NULL;
ALTER TABLE ledger_request_credits ALTER COLUMN effective_privacy_outcome SET DEFAULT 'plaintext';
ALTER TABLE ledger_request_credits ALTER COLUMN effective_privacy_outcome SET NOT NULL;
ALTER TABLE ledger_request_credits ALTER COLUMN positive_verification_excluded SET DEFAULT FALSE;
ALTER TABLE ledger_request_credits ALTER COLUMN positive_verification_excluded SET NOT NULL;
ALTER TABLE ledger_request_credits ALTER COLUMN rewards_excluded SET DEFAULT FALSE;
ALTER TABLE ledger_request_credits ALTER COLUMN rewards_excluded SET NOT NULL;
