...
echo "      # #290 R7 CODE MED — glob must expand INSIDE the sudo-macprovider"
echo "      # shell; otherwise the caller's shell (a sudo-capable non-root"
echo "      # operator who can't traverse the 0750 dir) expands to the"
echo "      # literal pattern and macprovider's ls fails with no-such-file."
