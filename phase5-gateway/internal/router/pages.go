...
var tier1DisclosureText = []disclosureItem{
	...
	{
		Key:  "model_identity",
		Text: "Model identity is provider-reported. When `/v1/models` aggregates the pool's served models, the model identifier reflects what the provider's binary advertises. SPEC-006 v0.6 does NOT cryptographically verify the loaded model against a catalog of known artifact hashes.",
	},
	{
		Key:  "tier2_milestone",
