...
var gatewayEmittedErrorCodes = []string{
	...
	"coordinator_models_error", "coordinator_receipt_error", "coordinator_sticky_error", "coordinator_unavailable",
	...
	"invalid_cursor", "invalid_provider_response", "invalid_request_body", "invalid_request_id", "invalid_window",
	"invalid_wallet_session", "keys_load_failed", "max_tokens_exceeded", "method_not_allowed",
	...
	"wallet_algorithm_unsupported", "wallet_canonical_invalid", "wallet_challenge_consumed",
	"wallet_challenge_expired", "wallet_identity_conflict", "wallet_signature_invalid",
	"wallet_account_auth_required", "wallet_account_mismatch", "wallet_session_admission_failed",
	"wallet_session_active_cap_exceeded", "wallet_session_body_forbidden",
	"wallet_session_cap_invalid", "wallet_session_challenge_failed",
	"wallet_session_duplicate_request", "wallet_session_expiry_invalid",
	"wallet_session_expired", "wallet_session_exhausted",
	...
	"wallet_session_scope_mismatch", "wallet_session_signature_invalid",
	"wallet_session_signature_stale", "wallet_session_storage_conflict", "wallet_session_store_failed",
	"wallet_sessions_disabled",
}
