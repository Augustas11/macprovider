...
def sign_payload(payload: bytes, private_key: pathlib.Path, signature: pathlib.Path, openssl: str) -> None:
...
def build(args: argparse.Namespace) -> None:
    ...
    sign_payload(signed_bytes, args.private_key, args.signature, args.openssl)
