...
"$validator" v1.8.50 1.8.50 "$valid_sha" "$valid_archive_sha" >/dev/null
...
expect_failure 1.8.50 1.8.50 "$valid_sha" "$valid_archive_sha"
expect_failure v1.8.49 1.8.50 "$valid_sha" "$valid_archive_sha"
expect_failure v1.8.50 1.8.49 "$valid_sha" "$valid_archive_sha"
expect_failure v1.8.50 1.8.50 "$(printf 'A%.0s' {1..64})" "$valid_archive_sha"
expect_failure v1.8.50 1.8.50 "${valid_sha%?}" "$valid_archive_sha"
expect_failure v1.8.50 1.8.50 "$valid_sha" "${valid_archive_sha}0"
