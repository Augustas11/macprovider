...
class BYOMContractLockTests(unittest.TestCase):
    ...
    def test_spec044_current_version_is_cross_spec_locked(self):
        ...
        self.assertIn("**Version:** 1.9.22", spec001)
        self.assertIn("**Version:** 0.2.10", spec044)
        self.assertIn('"version": "0.2.10"', spec044)
        self.assertIn("SPEC-044 v0.2.10", spec001)
        self.assertIn("| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.22 |", readme)
        ...
        self.assertEqual(spec001_record["version"], "1.9.22")
        spec_record = next(
