...
class HermeticReleaseTest(unittest.TestCase):
    ...
    def test_four_feed_release_is_unaffected_by_the_committed_unmeasured_source(self):
        ...
        with self.harness() as harness:
            ...
            harness.bump("published-2026-09-24-renewal-v1", "2026-09-24T00:00:00Z")
            harness.cut()
    ...
    def test_market_peg_bind_requires_named_market_inputs(self):
        ...
        with self.harness() as harness:
            ...
            harness.bump("published-2026-09-24-market-v1", "2026-09-24T00:00:00Z")
    ...
    def test_non_market_generate_does_not_require_market_provenance_bind(self):
        ...
        with self.harness() as harness:
            harness.bump("published-2026-09-24-manual-v1", "2026-09-24T00:00:00Z")
    ...
    def test_activation_requires_the_explicit_flag(self):
        with self.harness() as harness:
            ...
            harness.bump("published-2026-09-24-activation-v1", "2026-09-24T00:00:00Z")
    ...
    def activate(self, harness) -> str:
        release_id = "published-2026-09-24-activation-v1"
        harness.measure_sizes()
        harness.bump(release_id, "2026-09-24T00:00:00Z")
    ...
    def test_a_stale_published_feed_never_activates_implicitly(self):
        with self.harness() as harness:
            harness.measure_sizes()
            harness.bump("published-2026-09-24-stale-v1", "2026-09-24T00:00:00Z")
    ...
    def test_a_candidate_change_still_cuts_a_pre_activation_four_feed_release(self):
        ...
        with self.harness() as harness:
            ...
            harness.bump("published-2026-09-24-drift-v1", "2026-09-24T00:00:00Z")
            harness.cut()
            row = harness.ledger()["releases"]["published-2026-09-24-drift-v1"]
    ...
    def test_a_pre_activation_static_artifact_leftover_fails_verify(self):
        ...
        for leftover in ("autotune-artifacts.json", "autotune-artifacts.json.sig"):
            with self.subTest(leftover=leftover):
                with self.harness() as harness:
                    harness.bump("published-2026-09-24-leftover-v1", "2026-09-24T00:00:00Z")
                    harness.cut()
                    self.assertFalse((harness.catalog / "autotune-artifacts.json").exists())
...
class PreviousReleaseDirectoryTest(unittest.TestCase):
    ...
    def test_a_conforming_previous_release_loads(self):
        with self.activated() as (harness, previous, releases):
            ...
            self.assertEqual(loaded["release_id"], "published-2026-09-24-activation-v1")
