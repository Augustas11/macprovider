...
|---|---|---|---|---|---|---|
| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.3 | normative | pending | pending: 1 | [SPEC-001-phase3-binary.md](SPEC-001-phase3-binary.md) |
...
| SPEC-047 | Network Model Admission | 0.1.1 | draft | complete | pending: 8 | [SPEC-047-network-model-admission.md](SPEC-047-network-model-admission.md) |
