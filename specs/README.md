...
| SPEC-018 | Agentic tool calling (provider-side response synthesis) | 0.2.7 | normative | pending | pending: 1 | [SPEC-018-agentic-tool-calling.md](SPEC-018-agentic-tool-calling.md) |
...
| SPEC-023 | Installer-Integrated Autotune Recommend | v0.9.0 | normative | pending | pending: 2 | [SPEC-023-installer-autotune-recommend.md](SPEC-023-installer-autotune-recommend.md) |
