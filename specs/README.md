...
| SPEC-010 | Provider Model Catalog | 1.12 | normative | pending | conformant: 4, pending: 5 | [SPEC-010-model-catalog.md](SPEC-010-model-catalog.md) |
...
| SPEC-023 | Installer-Integrated Autotune Recommend | v0.17.0 | normative | pending | conformant: 2, pending: 15 | [SPEC-023-installer-autotune-recommend.md](SPEC-023-installer-autotune-recommend.md) |
...
| SPEC-047 | Network Model Admission | 0.2.1 | draft | complete | conformant: 6, pending: 3 | [SPEC-047-network-model-admission.md](SPEC-047-network-model-admission.md) |
