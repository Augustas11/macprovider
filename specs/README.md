...
|---|---|---|---|---|---|---|
| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.5 | normative | pending | pending: 1 | [SPEC-001-phase3-binary.md](SPEC-001-phase3-binary.md) |
...
| SPEC-020 | Provider autoupdate | v0.1.17 | normative | pending | pending: 5 | [SPEC-020-provider-autoupdate.md](SPEC-020-provider-autoupdate.md) |
...
| SPEC-025 | Native Mac App (signed `.dmg` + menu bar wrapper) | v0.25 | draft | pending | pending corpus migration | [SPEC-025-native-mac-app.md](SPEC-025-native-mac-app.md) |
