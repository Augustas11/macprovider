...
| SPEC-018 | Agentic tool calling (provider-side response synthesis) | 0.2.9 | normative | pending | conformant: 1, pending: 3 | [SPEC-018-agentic-tool-calling.md](SPEC-018-agentic-tool-calling.md) |
