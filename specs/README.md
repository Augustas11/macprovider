...
|---|---|---|---|---|---|---|
| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.9 | normative | pending | pending: 2 | [SPEC-001-phase3-binary.md](SPEC-001-phase3-binary.md) |
...
| SPEC-044 | Malibu Model Catalog Economics | 0.2.0 | draft | complete | pending: 12 | [SPEC-044-malibu-model-catalog-economics.md](SPEC-044-malibu-model-catalog-economics.md) |
