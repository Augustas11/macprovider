...
|---|---|---|---|---|---|---|
| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.0 | normative | pending | pending corpus migration | [SPEC-001-phase3-binary.md](SPEC-001-phase3-binary.md) |
...
| SPEC-025 | Native Mac App (signed `.dmg` + menu bar wrapper) | v0.17 | draft | pending | pending corpus migration | [SPEC-025-native-mac-app.md](SPEC-025-native-mac-app.md) |
