...
|---|---|---|---|---|---|---|
| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.18 | normative | pending | pending: 3 | [SPEC-001-phase3-binary.md](SPEC-001-phase3-binary.md) |
| SPEC-002 | Phase 4 Coordinator: Mac Provider Request Router | 1.6.1 | normative | pending | pending: 2 | [SPEC-002-coordinator.md](SPEC-002-coordinator.md) |
...
| SPEC-005 | Billing, Settlement, and Provider Rewards | 0.6.7 | normative | complete | conformant: 2, pending: 9 | [SPEC-005-billing.md](SPEC-005-billing.md) |
| SPEC-006 | Buyer API Gateway: Mac Provider's first public buyer surface | 0.9.29 | normative | complete | conformant: 2, pending: 10 | [SPEC-006-buyer-api.md](SPEC-006-buyer-api.md) |
...
| SPEC-010 | Provider Model Catalog | 1.9 | normative | pending | conformant: 4, pending: 3 | [SPEC-010-model-catalog.md](SPEC-010-model-catalog.md) |
...
| SPEC-018 | Agentic tool calling (provider-side response synthesis) | 0.2.8 | normative | pending | conformant: 1, pending: 2 | [SPEC-018-agentic-tool-calling.md](SPEC-018-agentic-tool-calling.md) |
...
| SPEC-022 | Verified model settlement | v0.1.8 | draft | complete | conformant: 5, pending: 6 | [SPEC-022-verified-model-settlement.md](SPEC-022-verified-model-settlement.md) |
| SPEC-023 | Installer-Integrated Autotune Recommend | v0.14.1 | normative | pending | conformant: 2, pending: 8 | [SPEC-023-installer-autotune-recommend.md](SPEC-023-installer-autotune-recommend.md) |
| SPEC-024 | Prefix-cache billing and provider-local cache isolation | 0.2.2 | normative | pending | pending: 1 | [SPEC-024-prefix-cache-billing.md](SPEC-024-prefix-cache-billing.md) |
...
| SPEC-032 | Autotune Hardware-Evidence Admission Gate, OPoI & Proof-of-Weights Boundary | v0.2.6 | draft | complete | conformant: 2, pending: 1 | [SPEC-032-proof-of-weights-hello-gate.md](SPEC-032-proof-of-weights-hello-gate.md) |
...
| SPEC-046 | Provider BYOM Discovery | 0.1.5 | draft | complete | conformant: 8 | [SPEC-046-provider-byom-discovery.md](SPEC-046-provider-byom-discovery.md) |
| SPEC-047 | Network Model Admission | 0.1.9 | draft | complete | conformant: 8, pending: 1 | [SPEC-047-network-model-admission.md](SPEC-047-network-model-admission.md) |
