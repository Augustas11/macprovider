...
| SPEC-006 | Buyer API Gateway: Mac Provider's first public buyer surface | 0.9.25 | normative | complete | conformant: 1, pending: 9 | [SPEC-006-buyer-api.md](SPEC-006-buyer-api.md) |
