...
| SPEC-022 | Verified model settlement | v0.2.0 | draft | complete | conformant: 4, pending: 8 | [SPEC-022-verified-model-settlement.md](SPEC-022-verified-model-settlement.md) |
