...
|---|---|---|---|---|---|---|
| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.19 | normative | pending | pending: 3 | [SPEC-001-phase3-binary.md](SPEC-001-phase3-binary.md) |
...
| SPEC-006 | Buyer API Gateway: Mac Provider's first public buyer surface | 0.9.32 | normative | complete | conformant: 2, pending: 13 | [SPEC-006-buyer-api.md](SPEC-006-buyer-api.md) |
...
| SPEC-010 | Provider Model Catalog | 1.10 | normative | pending | conformant: 4, pending: 3 | [SPEC-010-model-catalog.md](SPEC-010-model-catalog.md) |
...
| SPEC-015 | Verifiable inference receipts | 0.4.10 | normative | complete | conformant: 1, pending: 5 | [SPEC-015-receipts.md](SPEC-015-receipts.md) |
...
| SPEC-022 | Verified model settlement | v0.2.0 | draft | complete | conformant: 5, pending: 7 | [SPEC-022-verified-model-settlement.md](SPEC-022-verified-model-settlement.md) |
| SPEC-023 | Installer-Integrated Autotune Recommend | v0.16.0 | normative | pending | conformant: 2, pending: 14 | [SPEC-023-installer-autotune-recommend.md](SPEC-023-installer-autotune-recommend.md) |
...
| SPEC-032 | Autotune Hardware-Evidence Admission Gate, OPoI & Proof-of-Weights Boundary | v0.3.0 | draft | complete | conformant: 2, pending: 2 | [SPEC-032-proof-of-weights-hello-gate.md](SPEC-032-proof-of-weights-hello-gate.md) |
...
| SPEC-038 | Continuous batching for concurrent provider inference | v0.2.3 | draft | complete | pending: 17 | [SPEC-038-continuous-batching.md](SPEC-038-continuous-batching.md) |
...
| SPEC-046 | Provider BYOM Discovery | 0.2.0 | draft | complete | conformant: 6, pending: 3 | [SPEC-046-provider-byom-discovery.md](SPEC-046-provider-byom-discovery.md) |
| SPEC-047 | Network Model Admission | 0.2.0 | draft | complete | conformant: 7, pending: 2 | [SPEC-047-network-model-admission.md](SPEC-047-network-model-admission.md) |
