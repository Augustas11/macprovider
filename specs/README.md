...
| SPEC-037 | KV survival across provider restarts (encrypted provider-local disk tier) | v0.1.0 | draft | complete | pending: 12 | [SPEC-037-kv-survival-restart.md](SPEC-037-kv-survival-restart.md) |
