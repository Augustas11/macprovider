...
|---|---|---|---|---|---|---|
| SPEC-001 | Phase 3 Binary: Mac Provider Inference CLI | 1.9.11 | normative | pending | pending: 3 | [SPEC-001-phase3-binary.md](SPEC-001-phase3-binary.md) |
...
| SPEC-044 | Malibu Model Catalog Economics | 0.2.2 | draft | complete | pending: 12 | [SPEC-044-malibu-model-catalog-economics.md](SPEC-044-malibu-model-catalog-economics.md) |
...
| SPEC-047 | Network Model Admission | 0.1.6 | draft | complete | pending: 9 | [SPEC-047-network-model-admission.md](SPEC-047-network-model-admission.md) |
