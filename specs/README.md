...
| SPEC-024 | Prefix-cache billing and provider-local cache isolation | 0.2.5 | normative | pending | pending: 2 | [SPEC-024-prefix-cache-billing.md](SPEC-024-prefix-cache-billing.md) |
...
| SPEC-038 | Continuous batching for concurrent provider inference | v0.2.7 | draft | complete | pending: 17 | [SPEC-038-continuous-batching.md](SPEC-038-continuous-batching.md) |
