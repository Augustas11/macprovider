...
| SPEC-025 | Native Mac App (signed `.dmg` + menu bar wrapper) | v0.15 | [SPEC-025-native-mac-app.md](SPEC-025-native-mac-app.md) |
...
| SPEC-034 | Referral admission, provider invites, and advocacy rewards | v0.4.0 | [SPEC-034-referral-gated-prebeta.md](SPEC-034-referral-gated-prebeta.md) |
