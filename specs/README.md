...
| SPEC-023 | Installer-Integrated Autotune Recommend | v0.15.1 | normative | pending | conformant: 2, pending: 14 | [SPEC-023-installer-autotune-recommend.md](SPEC-023-installer-autotune-recommend.md) |
...
| SPEC-042 | Pool Control Plane and Trusted-Pool Manifest | 0.0.31 | draft | complete | pending: 12 | [SPEC-042-pool-control-plane.md](SPEC-042-pool-control-plane.md) |
