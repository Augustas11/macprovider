...
| SPEC-035 | Provider connection diagnostics and failure history | v0.1.0 | draft | complete | pending: 5 | [SPEC-035-provider-connection-diagnostics.md](SPEC-035-provider-connection-diagnostics.md) |
