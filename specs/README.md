...
| SPEC-006 | Buyer API Gateway: Mac Provider's first public buyer surface | 0.9.31 | normative | complete | conformant: 2, pending: 12 | [SPEC-006-buyer-api.md](SPEC-006-buyer-api.md) |
...
| SPEC-024 | Prefix-cache billing and provider-local cache isolation | 0.2.3 | normative | pending | pending: 2 | [SPEC-024-prefix-cache-billing.md](SPEC-024-prefix-cache-billing.md) |
...
| SPEC-038 | Continuous batching for concurrent provider inference | v0.2.2 | draft | complete | pending: 17 | [SPEC-038-continuous-batching.md](SPEC-038-continuous-batching.md) |
| SPEC-039 | Paged KV / paged-attention engine | v0.1.3 | draft | complete | pending: 14 | [SPEC-039-paged-kv-attention-engine.md](SPEC-039-paged-kv-attention-engine.md) |
