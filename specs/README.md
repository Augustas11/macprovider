...
| SPEC-023 | Installer-Integrated Autotune Recommend | v0.8.5 | normative | pending | pending: 2 | [SPEC-023-installer-autotune-recommend.md](SPEC-023-installer-autotune-recommend.md) |
...
| SPEC-038 | Continuous batching for concurrent provider inference | v0.2 | draft | complete | pending: 16 | [SPEC-038-continuous-batching.md](SPEC-038-continuous-batching.md) |
| SPEC-039 | Paged KV / paged-attention engine | v0.1 | draft | complete | pending: 9 | [SPEC-039-paged-kv-attention-engine.md](SPEC-039-paged-kv-attention-engine.md) |
