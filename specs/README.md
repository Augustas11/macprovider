...
| SPEC-010 | Provider Model Catalog | 1.11 | normative | pending | conformant: 4, pending: 4 | [SPEC-010-model-catalog.md](SPEC-010-model-catalog.md) |
...
| SPEC-022 | Verified model settlement | v0.2.0 | draft | complete | conformant: 3, pending: 9 | [SPEC-022-verified-model-settlement.md](SPEC-022-verified-model-settlement.md) |
...
| SPEC-047 | Network Model Admission | 0.2.0 | draft | complete | conformant: 6, pending: 3 | [SPEC-047-network-model-admission.md](SPEC-047-network-model-admission.md) |
