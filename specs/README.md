...
| SPEC-006 | Buyer API Gateway: Mac Provider's first public buyer surface | 0.9.8 | [SPEC-006-buyer-api.md](SPEC-006-buyer-api.md) |
...
| SPEC-025 | Native Mac App (signed `.dmg` + menu bar wrapper) | v0.3 | [SPEC-025-native-mac-app.md](SPEC-025-native-mac-app.md) |
| SPEC-026 | Browserless Provider Onboarding (one-click Launch Provider) | v0.15 | [SPEC-026-browserless-provider-onboarding.md](SPEC-026-browserless-provider-onboarding.md) |
