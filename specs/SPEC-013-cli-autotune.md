...
**(a) New provider onboarding: "I just installed malibu-cli.
What should I serve?"**
...
- **Shape B: rely on the runtime's online-fallback during load.**
  ...
  `phase3-binary/Sources/malibu-cli/ModelRuntime.swift`) first
...
small settle window) and that no orphan `malibu-cli` process
remains.
...
**Option A: Swift-native subcommand inside `malibu-cli`.**
