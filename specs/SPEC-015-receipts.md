...
**Depends on:** SPEC-001 v1.9.23, SPEC-002 v1.6.2 (v1.5 `GET /v1/receipt-keys/<provider_id>` buyer-safe pubkey resolver; v1.6 `/poolz` catalog fields + `/catalog/<catalog_id>` + `/catalog/pubkey` per §M.4), SPEC-005 v0.6.8 (settlement/accounting semantics), SPEC-006 v0.9.34, SPEC-008 v0.7.0 (hard — §5.3-5.6 model-hash semantics; §5.5 hash_status enum), SPEC-010 v1.11 (v1.7 R007(d), v1.10 R007(f) and v1.11 pool-scoped settlement for §N.12), SPEC-011 v0.5 (hard — §3.3.1 heartbeat `model_hash`; §3.2 warm-swap state machine; §3.3.0 opt-in gating), SPEC-013 v0.3.1, SPEC-022 v0.2.0 (hard — settlement-capable receipt profile consumer; R-12 for §N.12), SPEC-042 0.0.33 (pool runtime authorization for §N.12, v0.4.10)
...
- **AC-51:** Provider-signed usage without coordinator/gateway
  ...
  AC-022-66). The fixtures above still fail for it.
