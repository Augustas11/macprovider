...
run "SPEC-015 AC-01 AC-02 AC-03 AC-04 AC-05 AC-06 AC-07 AC-08 AC-09 AC-10 AC-11 AC-12 AC-13 AC-14 AC-15 AC-16 AC-17 manifest report" bash -lc 'cd test/integration && go test -v -race -count=1 -timeout 5m ./spec015'
