...
run "SPEC-015 v0.4 verified settlement receipt live gateway/coordinator/provider path" bash -lc 'cd test/integration && go test -race -count=1 -timeout 5m . -run TestSpec015V04SettlementReceiptCrossServiceVerifies'
...
run "SPEC-015 AC-15 nginx receipt header deployment buffers" bash phase4-coordinator/dist/test/check_nginx_receipt_buffers_test.sh
